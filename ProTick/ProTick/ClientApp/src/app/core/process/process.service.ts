...
export class ProcessService {
    ...
    putProcess(process: Process, processID: number) {
        return this.http.put<Process>(this.url + `/Process/${processID}`, process,
            { headers: this.jwtHeader.getJwtHeader() });
    }
    ...
    deleteProcess(processID: number): Observable<Process> {
        return this.http.delete<Process>(this.url + `/Process/${processID}`,
            { headers: this.jwtHeader.getJwtHeader() });
    }
